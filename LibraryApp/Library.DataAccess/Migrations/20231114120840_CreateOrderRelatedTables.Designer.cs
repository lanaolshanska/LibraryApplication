...
namespace Library.DataAccess.Migrations
{
    ...
    [Migration("20231114120840_CreateOrderRelatedTables")]
    partial class CreateOrderRelatedTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Models.PaymentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Models.ShipmentDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Models.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Library.Models.Order", b =>
                {
                    ...
                    b.HasOne("Library.Models.PaymentDetail", "PaymentDetail")
                        .WithMany()
                        .HasForeignKey("PaymentDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Library.Models.ShipmentDetail", "ShipmentDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("Library.Models.ShipmentDetail", b =>
                {
                    b.HasOne("Library.Models.UserAddress", "UserAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Library.Models.ApplicationUser", b =>
                {
                    b.HasOne("Library.Models.UserAddress", "Address")
                        .WithMany()
